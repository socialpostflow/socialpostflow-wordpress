...
<div class="wpzinc-option">
	<div class="full">
		...
		<a href="<?php echo esc_attr( $urls['export'] ); ?>" class="social-post-flow-export-log button">
			<?php esc_html_e( 'Export Log', 'social-post-flow' ); ?>
		</a>
		<a href="<?php echo esc_attr( $urls['clear'] ); ?>" class="social-post-flow-clear-log button wpzinc-button-red" data-action="social_post_flow_clear_log" data-target="#social-post-flow-log" data-message="<?php esc_attr_e( 'Are you sure you want to clear the logs associated with this Post?', 'social-post-flow' ); ?>">
