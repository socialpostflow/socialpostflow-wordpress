...
= 1.3.6 (2026-06-12) =
* Added: Profiles: Display warning and reconnect button when a profile disconnects from Social Post Flow
* Fix: API: Enable SSL verification by default
...
* Added: Text to Image: Strip URLs from text
...
* Added: Status: Display notice if duplicate statuses exist
...
* Fix: Status: Images: Additional Images: Auto populate from Post content: improve detection of images in content
